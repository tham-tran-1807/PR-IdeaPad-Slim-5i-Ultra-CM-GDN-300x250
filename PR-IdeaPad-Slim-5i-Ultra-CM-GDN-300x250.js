...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5i_Ultra_CM_GDN_300x250_atlas_1", frames: [[906,0,50,50],[0,0,300,250],[302,0,300,250],[582,718,288,110],[602,489,300,227],[0,252,300,249],[604,0,300,250],[602,252,300,235],[291,503,289,222],[302,252,298,249],[0,503,289,232]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5i_Ultra_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5iUltraCMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(362).call(this.frame_362).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(361).to({_off:false},0).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(349).to({_off:false},0).to({x:10.35,y:11},12).wait(29));
	...
	this.instance_3.setTransform(11,28);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(49).to({_off:false},0).to({_off:true},50).wait(291));

	// f1
	this.instance_8 = new lib.f1();
	this.instance_8.setTransform(11,69);
...
// library properties:
lib.properties = {
	id: '26FBEE4021510F408ED2C8246BBE64D8',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5i_Ultra_CM_GDN_300x250_atlas_1.png", id:"PR_IdeaPad_Slim_5i_Ultra_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['26FBEE4021510F408ED2C8246BBE64D8'] = {
